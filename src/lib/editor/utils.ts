...
export function downloadFile(file: string, type: string): void {
  ...
  anchorElement.download = `${generateUUID()}.${type}`;
...
export const createFilter = (
  value: string,
): InstanceType<typeof fabric.Image.filters.BaseFilter> | null => {
  let effect: InstanceType<typeof fabric.Image.filters.BaseFilter> | null = null;
